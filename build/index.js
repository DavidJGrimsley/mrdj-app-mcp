...
server.registerPrompt("full-app-build", {
    title: "Full app build",
    description: "Scan project/TODO.md, pick up the next incomplete task, complete one milestone at a time, then prompt to test and push to git.",
    argsSchema: {}
}, async () => {
    return {
        messages: [
            {
                ...
                content: {
                    type: "text",
                    text: "You are a senior builder executing incremental development cycles. Your workflow:\n\n1. READ project/TODO.md to identify milestones and task structure\n2. FIND the next incomplete task (look for [ ] checkboxes) within the next incomplete milestone\n3. CREATE a focused execution plan for that ONE milestone\n4. IMPLEMENT all tasks for that milestone systematically\n5. UPDATE project/TODO.md: mark completed tasks as [x] using replace_string_in_file\n6. PROMPT the user to test the changes\n7. ASK if they want to commit and push to git\n\nMILESTONE COMPLETION CRITERIA:\n- All [ ] tasks in the milestone section must be completed and marked [x]\n- Code must be implemented, not just planned\n- Follow relevant MCP guides (architecture, styling, routing, etc.)\n\nCRITICAL - DO NOT CALL THESE TOOLS:\n✗ mcp_mrdj-app-mcp_generate-project-todo (NEVER - this overwrites TODO.md)\n✗ mcp_mrdj-app-mcp_project-preflight (NOT needed for build workflow)\n✗ mcp_mrdj-app-mcp_ingest-project-context (only for initial setup)\n✗ mcp_mrdj-app-mcp_update-app-naming (only for initial setup)\n✗ mcp_mrdj-app-mcp_update-readme (only for initial setup)\n✗ mcp_mrdj-app-mcp_generate-project-instructions (only for initial setup)\n\nDO NOT:\n- Skip ahead to later milestones\n- Mark tasks complete without implementing code\n- Regenerate or overwrite TODO.md - ONLY update existing checkboxes\n- Ask clarifying questions unless critically blocked (infer reasonable defaults)\n\nUSE:\n- read_file to read project/TODO.md, project/info.md, project/style.md\n- replace_string_in_file to update [ ] to [x] in TODO.md\n- mcp_mrdj-app-mcp_read-guide for implementation patterns\n- manage_todo_list tool to track sub-tasks within the milestone\n\nIf project/TODO.md is missing or empty, instruct user to run project-intake prompt first."
                }
            },
            {
                role: "user",
                content: {
                    type: "text",
                    text: "Execute the full-app-build workflow:\n\n**PHASE 1: SCAN & PLAN**\n1. Use read_file to read the EXISTING project/TODO.md (DO NOT generate it)\n2. Identify the next incomplete milestone (first [ ] milestone)\n3. List all incomplete tasks [ ] within that milestone\n4. Create a todo list for this work session using manage_todo_list\n5. Show me:\n   - Current milestone name\n   - Number of tasks to complete\n   - Brief execution plan (1-3 sentences)\n\n**PHASE 2: IMPLEMENT**\n6. Complete each task in the milestone systematically\n7. Read MCP guides as needed using mcp_mrdj-app-mcp_read-guide\n8. Mark each task complete in manage_todo_list as you finish it\n9. After ALL tasks are done, use replace_string_in_file to update project/TODO.md:\n   - Change ONLY the specific [ ] to [x] for completed tasks\n   - Preserve all other content exactly as-is\n   - DO NOT regenerate or rewrite the file\n\n**PHASE 3: HANDOFF**\n10. Summarize what was implemented (bullet list, max 5 items)\n11. Ask: \"Ready to test? Please verify the changes work as expected.\"\n12. After I confirm, ask: \"Would you like me to commit and push these changes to git?\"\n\n**CRITICAL RULES:**\n✓ Read existing TODO.md with read_file\n✓ Update checkboxes with replace_string_in_file ONLY\n✓ Complete ONE full milestone per run\n✓ Implement actual code, not pseudocode\n✓ Stop and wait for my approval before git operations\n\n✗ NEVER call mcp_mrdj-app-mcp_generate-project-todo\n✗ NEVER regenerate or overwrite TODO.md\n✗ Do NOT move to next milestone automatically\n✗ Do NOT mark tasks complete without implementation\n✗ Do NOT commit to git without asking first"
                }
            }
        ]
    };
