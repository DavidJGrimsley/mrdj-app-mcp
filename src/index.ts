      ...
      messages: [
        {
          ...
          content: {
            type: "text",
            text:
              "You are preparing project context for a build. Use the project/ folder as the source of truth. Convert raw txt into clean markdown, then generate copilot instructions that merge project context with guides. Keep output concise and actionable."
          }
        },
        {
          role: "user",
      ...
      messages: [
        {
          ...
          content: {
            type: "text",
            text:
              "You are a senior builder. Use project/info.md and project/style.md as primary context, plus the MCP guides. First, summarize the project in 5-8 bullets, infer app type (web/app/both), then produce a detailed plan. Ask all clarifying questions in one list. After the user answers, auto-start tasks and keep a running todo list."
          }
        },
        {
          role: "user",
